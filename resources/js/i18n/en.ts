...
const en = {
    ...
    cart: {
        ...
        couponApply: 'Apply',
        couponRemove: 'Remove',
        giftLabel: 'This order is a gift',
        giftHint: 'We will pack it as a gift. Prices are never printed inside the box.',
    ...
    checkout: {
        ...
        shortAddressUnknown: "Don't know yours?",
        shortAddressLookup: 'Find it on Saudi Post',
        shortAddressAsk: 'ask them on WhatsApp',
        ...
        fulfillmentOptions: {
            ...
            collection: { label: 'Collect from the shop', hint: 'Pick it up yourself. No shipping fee.' },
        },
        collectionAddress: 'Retab Dates, 7708 King Fahd Road, Al Malqa, Riyadh 13521. We will message you when your order is ready to collect.',
        otherRecipient: 'Someone else will receive this order',
    ...
    admin: {
        ...
        uploads: {
            ...
            failed: 'Could not save. Your typing is kept, so use Resume to try again.',
        ...
        hero: {
            ...
            save: 'Save slide',
            emptyTitle: 'No slides of your own yet',
            emptyHint: 'Until you add one, the homepage shows the four pictures the site was built with.',
            previewTitle: 'What shoppers will see',
            previewNote: 'In this order, rotating',
            dragHint: 'Drag a card to reorder. Campaign banners are set by their campaign.',
            cropEmpty: 'Choose a picture or video and you will see exactly how it is cropped.',
            cropDesktop: 'On computers',
            cropPhone: 'On phones',
            cropFits: 'This fits the space exactly, so nothing is cut.',
            cropDrag: 'Drag the white box to choose what stays in view. Arrow keys nudge it.',
            cropPhoneShared: 'On phones (using the computer version)',
            trimsEdges: 'the sides will be trimmed',
            trimsSides: 'the top and bottom will be trimmed',
            recommended: 'Best size: {{w}} x {{h}}',
            ...
            fromYou: 'Yours',
            // No count and no plural on purpose: i18next reserves `count` for
            // pluralization, which Arabic needs six variants for. The preview
            // above already shows exactly how many and which.
            campaignRunning: 'A campaign is running right now, so its banners are part of the mix above.',
            modeTitle: 'When a campaign is running',
            modeIntro: 'Campaigns (Store events) can put their own banners on the homepage. This decides what happens to yours while one is on.',
            modes: {
                takeover: { label: 'Campaign only', hint: 'The campaign takes the homepage. Your slides come back by themselves when it ends.' },
                merge: { label: 'Campaign, then mine', hint: 'Both rotate together, campaign banners first.' },
                mine: { label: 'Always mine', hint: 'Campaign banners never appear here. Only what you add below.' },
            },
            kind: 'What is this slide?',
            kinds: { image: 'Picture', video: 'Video' },
            imageDesktop: 'Picture (computers)',
            imageDesktopHint: 'Wide, twice as long as it is tall. Around 1920 x 960.',
            imagePhone: 'Picture for phones (optional)',
            imagePhoneHint: 'Upright, taller than wide. Add one and phones use it instead of cropping the computer picture.',
            video: 'Video file',
            videoHint: 'MP4 or WEBM, up to {{n}} MB. It plays silently and on a loop, so keep it short.',
            poster: 'First frame (optional)',
            posterHint: 'Shown while the video loads, and instead of it for shoppers who turn off animations.',
            altAr: 'Description (Arabic)',
            altHint: 'What is in the banner, for shoppers using a screen reader.',
            ...
            draftRestored: 'We kept what you had typed. Please choose your picture or video again, because files cannot be saved.',
            ...
            linkKinds: {
                none: 'Nothing, it is just a banner',
                shop: 'The shop (all products)',
                category: 'A category',
                product: 'A product',
                event: 'A campaign',
                url: 'Another website',
            },
            linkPick: { category: 'Which category?', product: 'Which product?', event: 'Which campaign?' },
            linkChoose: 'Choose one…',
            linkUrl: 'Web address',
            linkUrlHint: 'Must start with https://. It opens in a new tab.',
            linkNoneHint: 'Shoppers cannot tap this banner.',
            linkResult: 'Shoppers will be taken to: {{path}}',
            groupWhen: 'When it runs',
            groupShow: 'Order and visibility',
            groupAlt: 'Description',
            whenHint: 'Leave both empty and it runs until you hide it.',
            startsAt: 'Starts (optional)',
            endsAt: 'Ends (optional)',
            noStart: 'Starts now',
            noEnd: 'No end date',
            order: 'Order',
            showOnStore: 'Show on the store',
            on: 'Showing',
            off: 'Hidden',
            moveUp: 'Move up',
            moveDown: 'Move down',
        ...
        announcements: {
            ...
            message: 'Message',
            window: 'Shows between',
            messageAr: 'Message (Arabic)',
            messageEn: 'Message in English (optional, falls back to Arabic)',
            linkUrl: 'Link (optional)',
            linkLabelAr: 'Link text (Arabic)',
            linkLabelEn: 'Link text (English)',
            tone: 'Look',
            tones: { info: 'Information', warning: 'Warning', success: 'Good news' },
            startsAt: 'Starts',
            endsAt: 'Ends',
            datesHint: 'Leave both blank to show it right away and keep it up until you switch it off. Set an end date and it removes itself.',
            noStart: 'Starts: right away',
            noEnd: 'Ends: when you switch it off',
            isActive: 'Switched on',
            on: 'On',
            off: 'Off',
            emptyTitle: 'No announcements yet',
            emptyHint: 'Nothing is showing above the storefront.',
        ...
        help: {
            ...
            pages: {
                ...
                categories: {
                    intro: 'The store’s top menu is built from these categories, and every product is filed under one of them.',
                    steps: [
                        'A top-level category with subcategories becomes a dropdown in the top menu, like Dates and Gifts. It holds no products itself.',
                        'Every other category holds products. Choose it in the Category field of the product form.',
                        'Give a category an image to show it as a tile in the homepage Categories section. A transparent PNG or WebP works best.',
                        'Use the arrows to change the order. The same order is used in the menu, the store filters and the homepage tiles.',
                    ],
                    rules: [
                        'A category only shows on the store once it holds at least one visible product, so a new one stays out of sight until you add products to it.',
                        'Deleting a category never deletes its products. You choose a category to move them to, or leave them without one: they stay on sale, can be found by search, and are listed under the “No category” filter on Products.',
                        'A group with subcategories cannot be deleted until its subcategories are moved or deleted.',
                        'On the Products list, tick several products to move them to another category, show or hide them, or delete them in one go.',
                        'Hiding a category takes it out of the menu, the filters and the homepage tiles. Its products stay on sale and can still be found by search.',
                        'Changing a category’s link breaks links that were already shared on WhatsApp or social media.',
                        'Special Offers is used by store events. It can be renamed or hidden, but not deleted or moved.',
                    ],
                },
                productReviews: {
        ...
        categories: {
            title: 'Categories',
            subtitle: 'The groups in the store’s top menu and the categories products are filed under. Changes show on the store straight away.',
            new: 'New category',
            edit: 'Edit category',
            ...
            group: 'Menu group',
            groupHint: 'Opens a dropdown in the top menu. It holds subcategories, not products.',
            subcategories: '{{n}} subcategories',
            productCount: '{{n}} products',
            noProducts: 'No products yet',
            homepageTile: 'Homepage tile',
            noTile: 'No homepage tile',
            visible: 'Visible',
            hidden: 'Hidden',
            hideHint: 'Visible on the store. Click to hide it.',
            showHint: 'Hidden from the store. Click to show it.',
            moveUp: 'Move up',
            moveDown: 'Move down',
            usedByEvents: 'Used by store events',
            notOnStore: 'Not on the store yet: no visible products',
            notOnStoreGroup: 'Not on the store yet: no subcategory has visible products',
            deleteDialog: {
                title: 'Delete category',
                lead: '“{{name}}” holds {{n}} products. They are never deleted with it.',
                leadEmpty: 'Delete “{{name}}”?',
                moveTo: 'Move its products to',
                leaveUncategorized: 'Leave them without a category',
                uncategorizedHint: 'They stay on sale and can still be found by search. Filter Products by “No category” to file them again later.',
                movedHint: 'They move to the chosen category before this one is deleted.',
                confirm: 'Delete category',
            },
            blocked: {
                category_has_children: 'Still has subcategories. Move or delete them first.',
                category_protected: 'Store events put their offers here, so it cannot be deleted. Hide it instead.',
            },
            emptyTitle: 'No categories yet',
            empty: 'Create a category to start filing products under it.',
            form: {
                nameAr: 'Name (Arabic)',
                nameEn: 'Name (English)',
                nameEnHint: 'Optional. English visitors see the Arabic name when this is empty.',
                parent: 'Sits under',
                topLevel: 'Top level (its own item in the menu)',
                parentHint: 'Choose a group to put this category in its dropdown.',
                parentLockedGroup: 'This category has subcategories, so it stays at the top level.',
                parentLockedOffers: 'Special Offers stays at the top level.',
                slug: 'Link',
                slugPlaceholder: 'Made from the name when left empty',
                slugPreview: 'Store link: /shop?category={{slug}}',
                slugChanged: 'Changing this breaks links that were already shared.',
                slugLocked: 'Store events find Special Offers by this link, so it cannot be changed.',
                image: 'Homepage tile image',
                imageHint: 'Shown as a tile in the homepage Categories section. A transparent PNG or WebP works best. No image means no tile.',
                chooseImage: 'Choose image',
                replaceImage: 'Replace image',
                removeImage: 'Remove image',
                undoRemove: 'Keep image',
                imageRemoved: 'The image will be removed when you save.',
                visible: 'Visible on the store',
                visibleHint: 'A hidden category leaves the menu, the filters and the homepage tiles. Its products stay on sale.',
            },
        },
        productReviews: {
        ...
        products: {
            ...
            bulk: {
                ...
                moveTitle: 'Move products',
                moveConfirm: 'Move {{n}} selected products to “{{name}}”?',
                moveConfirmNone: 'Take {{n}} selected products out of their category? They stay on sale and can still be found by search.',
                move: 'Move',
                show: 'Show on store',
                hide: 'Hide from store',
                delete: 'Delete selected',
                deleteItem: '{{n}} selected products',
            ...
            form: {
                ...
                draftRestored: 'We kept what you had typed. Please choose your pictures again, because files cannot be saved.',
                draftDismiss: 'Got it',
        ...
        orders: {
            ...
            show: {
                ...
                markTransferReceived: 'Mark transfer received',
                transferTitle: 'Record the bank transfer',
                transferBody: 'Only do this once you can see {{amount}} in the bank account. The order then moves on to confirmation.',
                transferReference: 'Bank reference (optional)',
                transferReferenceHint: 'The transaction number on the bank statement, so the transfer can be matched later.',
                unavailableTitle: 'Mark this order unavailable',
                unavailableBody: 'The customer gets a WhatsApp apology and any payment hold is released.',
                back: 'Back',
                whatsapp: 'WhatsApp',
                ...
                companyName: 'Company',
                companyCr: 'Commercial registration',
                companyVat: 'VAT number',
                packingNotes: 'Packing notes',
                isGift: 'Gift order. Pack as a gift, and put no price or invoice in the box.',
                isCollection: 'Collection from the shop. Do not hand this to a courier.',
                trackParcel: 'Track parcel',
                shippingLabel: 'Shipping label',
                nextStep: 'Next step',
                notes: 'Internal notes',
                notesPlaceholder: 'Only staff can see these notes.',
                notesSave: 'Save notes',
                notesEmpty: 'No notes.',
                next: {
                    bankTransfer:
                        'Waiting for a bank transfer of {{amount}} to {{bank}}. The customer quotes {{number}} as the reference. Once it shows in the account, mark it received.',
                    gateway: 'Waiting for the customer to finish paying online. If the payment failed or the hold lapsed, send them a payment link.',
                    pendingPayment: 'Waiting for payment.',
                    awaiting: 'Paid. Check the items are in stock, then confirm the order or mark it unavailable.',
                    confirmed: 'Confirmed and stock deducted. Pack the order, then book the courier.',
                    shipped: 'On its way with {{carrier}}, tracking {{tracking}}. Waiting for delivery.',
                    delivered: 'Delivered. Nothing left to do.',
                    cancelled: 'Cancelled. Nothing left to do.',
                    unavailable: 'Marked unavailable. The customer was told and any payment hold was released.',
                },
            },
            shipping: {
        ...
        storeEvents: {
            ...
            fields: {
                ...
                utcHint: 'Enter times in UTC, three hours behind Riyadh: midnight in Riyadh is 21:00 the day before.',
                riyadhEquals: 'Riyadh: {{date}}',
            },
            offer: {
                artwork: 'Artwork',
            ...
            summary: {
                ...
                ended: 'Ended',
                bannersLive: '{{live}} of {{total}} banners live',
                offersOnSale: '{{live}} of {{total}} offers on sale',
            ...
            offersTab: {
                hint: 'What this event puts on sale, in this order on the homepage. Prices and discounts come from each product.',
                addExisting: 'Add existing product',
                edit: 'Badge & artwork',
                artworkHint: 'Optional wide 2:1 image for this offer’s homepage card. Without one, the card uses the product photo.',
                emptyTitle: 'No offers yet',
                emptyHint: 'Add a product from the catalogue, or create a campaign-only product such as a bundle.',
            },
            createOffer: {
            ...
            banners: {
                ...
                addTitle: 'New hero banner',
                followsEvent: 'Follows the event dates',
                dates: 'Own dates',
                clearDates: 'Follow the event',
                item: 'Banner {{n}}',
                phoneFallback:
                    '{{n}} banner(s) have no phone image, so phones show the desktop image for the whole set. Add a phone image to each to use the phone layout.',
                emptyTitle: 'No hero banners yet',
                emptyHint: 'Add one and, while this event runs, the homepage hero shows your campaign artwork instead of the usual photos.',
                ...
                state: {
                    ...
                    no_offers: 'Event has no live offers',
                },
            },
        },
        discounts: {
