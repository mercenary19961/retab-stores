    ...
    return (
        <section className="relative w-full overflow-hidden">
            ...
            <div className="absolute inset-y-0 right-0 flex w-[48%] flex-col items-center justify-center gap-[1.5%] px-[2%] text-center">
                <h2 className="font-heading text-brand-gold text-[clamp(1.75rem,9vw,7.5rem)] leading-none font-black">{t('primaryBanner.title')}</h2>
                <p className="font-heading text-[clamp(0.85rem,3.6vw,3rem)] leading-tight font-bold text-white">{t('primaryBanner.subtitle')}</p>
                <Link
                    href="/shop"
                    className="bg-brand-teal font-heading hover:bg-brand-teal/90 mt-[3%] inline-block rounded-full px-[7%] py-[1.6%] text-[clamp(0.8rem,2.4vw,2rem)] font-black text-white shadow-xl ring-1 ring-white/20 transition-colors"
                >
