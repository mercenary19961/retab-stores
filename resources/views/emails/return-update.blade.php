        ...
        <tr>
            <td style="padding:18px 20px; text-align:{{ $align }}; font-size:14px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size:14px;">
                    ...
                    <tr>
                        <td style="padding:4px 0; color:#6b6b6b; text-align:{{ $align }}; white-space:nowrap;">{{ __('emails.return_update.status_label') }}</td>
                        <td style="padding:4px 0; color:#2b2b2b; font-weight:bold; text-align:{{ $align }};">{{ $statusLabel }}</td>
                    </tr>
                </table>
                <p style="margin:12px 0 0 0; color:#2b2b2b;">{{ $statusNote }}</p>
            </td>
        </tr>
    </table>
