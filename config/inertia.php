...
return [
    ...
    */
    ...
    'ssr' => [
        ...
        // Opt-in via env: OFF by default (dev has no SSR process; `composer run
        // dev` stays CSR). Production sets INERTIA_SSR_ENABLED=true once the
        // sidecar service exists. See CLAUDE.md → Deployment + SSR.
        ...
        // Read by App\Ssr\TimeoutHttpGateway (not stock Inertia): max seconds
        // for the sidecar response / TCP connect before falling back to CSR.
        // Kept well under Railway's ~15s proxy timeout so a hung sidecar
        // degrades to client rendering instead of 502ing the site.
