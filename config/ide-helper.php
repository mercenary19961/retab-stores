...
return [
    ...
    */
    ...
    // Adds `@mixin \Eloquent` to vendor's base Model docblock so Intelephense
    // resolves static builder calls (Product::where(...)) with the correct
    // optional-param signatures. Vendor edit is wiped by composer update; the
    // post-update-cmd hook re-applies it via ide-helper:generate. See the
    // Intelephense gotcha in CLAUDE.md → Local Development for the full story
    // (the P1005 noise itself came from vendor/_laravel_ide, now excluded).
