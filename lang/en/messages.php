...
return [
    ...
    'auth' => [
        ...
        'google_email_taken' => 'That email address is already registered. Please sign in with your password instead.',
    ...
    'admin' => [
        ...
        'role_owner_only' => 'Only the store owner account can decide who is an admin.',
        'password_reset_owner' => 'The store owner’s password can only be changed by the owner.',
        'email_alerts_on' => ':name will now receive alert emails.',
        'email_alerts_off' => ':name will no longer receive alert emails.',
        ...
        'category_shown' => 'Category is visible on the store again.',
        'category_hidden' => 'Category hidden. It no longer appears in the navbar, the filters or the homepage tiles.',
        'category_deleted_moved' => 'Category deleted. Its :count products moved to :name.',
        'category_deleted_orphaned' => 'Category deleted. Its :count products are now without a category: still on sale, and listed under the “No category” filter on Products.',
        'category_move_target_invalid' => 'Products can only go into a category that holds products, not into a menu group.',
        'category_has_children' => 'This group still has subcategories. Move or delete them first.',
        'category_protected' => 'Special Offers is where store events put their offers, so it cannot be deleted. Hide it instead.',
        'category_parent_self' => 'A category cannot sit under itself.',
        'category_parent_depth' => 'Subcategories only go one level deep. Choose a top-level group.',
        'category_parent_has_products' => 'That category holds products, so it cannot also hold subcategories.',
        'category_group_stays_top' => 'This category has subcategories, so it has to stay at the top level.',
        'category_slug_locked' => 'Store events find Special Offers by this link, so it cannot be changed.',
        'category_offers_top_level' => 'Special Offers has to stay at the top level.',
        'category_image_invalid' => 'Only JPG, PNG, WEBP or GIF images are allowed.',
        ...
        'carrier_favourited' => ':name is pinned to the top of the list.',
        'carrier_unfavourited' => ':name is no longer pinned.',
        ...
        'bulk_moved' => 'Moved :count products to :name.',
        'bulk_uncategorized' => ':count products are now without a category. They stay on sale and can be found by search.',
        'bulk_nothing_changed' => 'Nothing changed: the selected products were already like that.',
        'bulk_shown' => ':count products are now visible on the store.',
        'bulk_hidden' => ':count products hidden from the store.',
        'bulk_show_blocked' => ':count stay hidden because they are missing a price or an image.',
        'bulk_products_deleted' => 'Deleted :count products. Each can be restored from the change log.',
